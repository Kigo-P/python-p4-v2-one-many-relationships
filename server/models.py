...
class Employee(db.Model):
    ...
    # a relationship mapping the employee to the related reviews
    reviews = db.relationship("Review", back_populates="employee", cascade="all, delete-orphan")

    # a relationship that maps the employee to the related onboarding
...
class Onboarding(db.Model):
    ...
    # Foreign key for the employees.id
    employee_id = db.Column(db.Integer, db.ForeignKey("employees.id"))

    # a relationship that maps the onboarding to the employee
...
class Review(db.Model):
    ...
    # creating a foreign key to store the employee id
    employee_id = db.Column(db.Integer, db.ForeignKey("employees.id"))

    # a relationship mapping the review to the related employee
